export const chatUsersForm = `<form class="form form_chat-users" name="chat-users" id="myChatUsersForm" novalidate="">
   <fieldset class="form__fieldset" name="fieldset">
      <legend class="form__legend">کاربران را اضافه کنید</legend>
      <div class="form__container">
         <input id="chat-users" type="text" name="chatUsers" class="input form__input form__input_auth" placeholder="نام کاربری را وارد کنید" accept="image/*" required>
