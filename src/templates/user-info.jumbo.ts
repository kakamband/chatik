...
<form class="form form_user" name="user" id="user" novalidate>
   ...
   <fieldset class="form__fieldset" name="fieldset">
      ...
      <div class="form__container">
         <input type="text" name="first_name" class="input form__input form__input_user" id="user-first-name" placeholder="اسمت رو وارد کن" pattern="^([\\w\\W]{8,30})$" value="{{first_name}}" required>
         <p class="error error_type_first-name" id="first_name"></p>
      </div>
      <div class="form__container">
         <input type="text" name="second_name" class="input form__input form__input_user" id="user-second-name" placeholder="فامیلیت رو وارد کن" pattern="^([\\w\\W]{8,30})$" value="{{second_name}}" required>
         <p class="error error_type_second-name" id="second_name"></p>
      </div>
      <div class="form__container">
         <input type="text" name="display_name" class="input form__input form__input_user" id="user-display-name" placeholder="نام نمایشیت رو وارد کنید" pattern="^([\\w\\W]{8,30})$" value="{{display_name}}" required>
      ...
      <div class="form__container">
         <input type="tel" name="phone" class="input form__input form__input_user" id="user-phone" placeholder="شماره همراهت رو وارد کنید" pattern="^(\\+7((\\(\\d{3}\\)\\s?\\d{3}-\\d{2}-\\d{2})|(\\s\\d{3}-\\d{3}-\\d{2}-\\d{2})|(\\d{10})))|(8\\d{10})$" value="{{phone}}" required>
